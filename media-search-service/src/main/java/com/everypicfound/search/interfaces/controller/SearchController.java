...
public class SearchController {
    ...
    private SearchCommand buildImageSearchCommand(ImageSearchRequest request) throws IOException {
        ...
        boolean emptyFile = isEmptyFile(queryImage);
        return SearchCommand.builder()
                .searchType(SearchType.IMAGE)
                .queryImage(emptyFile ? null : queryImage.getInputStream())
                .queryImageOriginalFileName(emptyFile ? null : queryImage.getOriginalFilename())
                .queryImageFileSize(emptyFile ? null : queryImage.getSize())
                .queryImageMimeType(emptyFile ? null : queryImage.getContentType())
