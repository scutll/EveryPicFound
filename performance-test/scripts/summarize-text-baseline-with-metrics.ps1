...
foreach ($item in $manifest) {
    ...
    $searchCount = Delta (Get-MetricSum $after 'everypicfound_search_requests_total' @{ search_type = 'text'; result = 'success' }) `
                         (Get-MetricSum $before 'everypicfound_search_requests_total' @{ search_type = 'text'; result = 'success' })

    $searchSum = Delta (Get-MetricSum $after 'everypicfound_search_duration_seconds_sum' @{ search_type = 'text'; result = 'success' }) `
                       (Get-MetricSum $before 'everypicfound_search_duration_seconds_sum' @{ search_type = 'text'; result = 'success' })

    $searchCacheNaCount = Delta (Get-MetricSum $after 'everypicfound_search_requests_total' @{ search_type = 'text'; result = 'success'; cache_result = 'not_applicable' }) `
                               (Get-MetricSum $before 'everypicfound_search_requests_total' @{ search_type = 'text'; result = 'success'; cache_result = 'not_applicable' })
    $searchCacheHitCount = Delta (Get-MetricSum $after 'everypicfound_search_requests_total' @{ search_type = 'text'; result = 'success'; cache_result = 'hit' }) `
                                (Get-MetricSum $before 'everypicfound_search_requests_total' @{ search_type = 'text'; result = 'success'; cache_result = 'hit' })
    $searchCacheMissCount = Delta (Get-MetricSum $after 'everypicfound_search_requests_total' @{ search_type = 'text'; result = 'success'; cache_result = 'miss' }) `
                                 (Get-MetricSum $before 'everypicfound_search_requests_total' @{ search_type = 'text'; result = 'success'; cache_result = 'miss' })

    $queryVectorizeSum = Delta (Get-MetricSum $after 'everypicfound_search_stage_duration_seconds_sum' @{ search_type = 'text'; stage = 'query_vectorize'; result = 'success' }) `
                              (Get-MetricSum $before 'everypicfound_search_stage_duration_seconds_sum' @{ search_type = 'text'; stage = 'query_vectorize'; result = 'success' })

    $vectorRecallSum = Delta (Get-MetricSum $after 'everypicfound_search_stage_duration_seconds_sum' @{ search_type = 'text'; stage = 'vector_recall'; result = 'success' }) `
                            (Get-MetricSum $before 'everypicfound_search_stage_duration_seconds_sum' @{ search_type = 'text'; stage = 'vector_recall'; result = 'success' })

    $backfillSum = Delta (Get-MetricSum $after 'everypicfound_search_stage_duration_seconds_sum' @{ search_type = 'text'; stage = 'backfill'; result = 'success' }) `
                        (Get-MetricSum $before 'everypicfound_search_stage_duration_seconds_sum' @{ search_type = 'text'; stage = 'backfill'; result = 'success' })

    $repoSum = Delta (Get-MetricSum $after 'everypicfound_image_asset_repository_duration_seconds_sum' @{ operation = 'find_by_ids'; result = 'success' }) `
                     (Get-MetricSum $before 'everypicfound_image_asset_repository_duration_seconds_sum' @{ operation = 'find_by_ids'; result = 'success' })

    $repoCount = Delta (Get-MetricSum $after 'everypicfound_image_asset_repository_duration_seconds_count' @{ operation = 'find_by_ids'; result = 'success' }) `
                       (Get-MetricSum $before 'everypicfound_image_asset_repository_duration_seconds_count' @{ operation = 'find_by_ids'; result = 'success' })

    $modelSum = Delta (Get-MetricSum $after 'everypicfound_model_http_duration_seconds_sum' @{ endpoint = 'vectorize_text'; result = 'success' }) `
                      (Get-MetricSum $before 'everypicfound_model_http_duration_seconds_sum' @{ endpoint = 'vectorize_text'; result = 'success' })

    $modelCount = Delta (Get-MetricSum $after 'everypicfound_model_http_duration_seconds_count' @{ endpoint = 'vectorize_text'; result = 'success' }) `
                        (Get-MetricSum $before 'everypicfound_model_http_duration_seconds_count' @{ endpoint = 'vectorize_text'; result = 'success' })

    $qdrantSum = Delta (Get-MetricSum $after 'everypicfound_vector_index_duration_seconds_sum' @{ operation = 'search'; result = 'success' }) `
                       (Get-MetricSum $before 'everypicfound_vector_index_duration_seconds_sum' @{ operation = 'search'; result = 'success' })

    $qdrantCount = Delta (Get-MetricSum $after 'everypicfound_vector_index_duration_seconds_count' @{ operation = 'search'; result = 'success' }) `
                         (Get-MetricSum $before 'everypicfound_vector_index_duration_seconds_count' @{ operation = 'search'; result = 'success' })

    $imageAccessSum = Delta (Get-MetricSum $after 'everypicfound_image_access_duration_seconds_sum' @{ result = 'success' }) `
                           (Get-MetricSum $before 'everypicfound_image_access_duration_seconds_sum' @{ result = 'success' })

    $imageAccessCount = Delta (Get-MetricSum $after 'everypicfound_image_access_duration_seconds_count' @{ result = 'success' }) `
                             (Get-MetricSum $before 'everypicfound_image_access_duration_seconds_count' @{ result = 'success' })

    $cacheSearchGetSkipped = Delta (Get-MetricSum $after 'everypicfound_cache_duration_seconds_count' @{ cache_name = 'search_result'; operation = 'get'; result = 'skipped' }) `
                                  (Get-MetricSum $before 'everypicfound_cache_duration_seconds_count' @{ cache_name = 'search_result'; operation = 'get'; result = 'skipped' })
    $cacheSearchGetHit = Delta (Get-MetricSum $after 'everypicfound_cache_duration_seconds_count' @{ cache_name = 'search_result'; operation = 'get'; result = 'hit' }) `
                              (Get-MetricSum $before 'everypicfound_cache_duration_seconds_count' @{ cache_name = 'search_result'; operation = 'get'; result = 'hit' })
    $cacheSearchGetMiss = Delta (Get-MetricSum $after 'everypicfound_cache_duration_seconds_count' @{ cache_name = 'search_result'; operation = 'get'; result = 'miss' }) `
                               (Get-MetricSum $before 'everypicfound_cache_duration_seconds_count' @{ cache_name = 'search_result'; operation = 'get'; result = 'miss' })

    $cacheTextGetSkipped = Delta (Get-MetricSum $after 'everypicfound_cache_duration_seconds_count' @{ cache_name = 'text_vector'; operation = 'get'; result = 'skipped' }) `
                                (Get-MetricSum $before 'everypicfound_cache_duration_seconds_count' @{ cache_name = 'text_vector'; operation = 'get'; result = 'skipped' })
    $cacheTextGetHit = Delta (Get-MetricSum $after 'everypicfound_cache_duration_seconds_count' @{ cache_name = 'text_vector'; operation = 'get'; result = 'hit' }) `
                            (Get-MetricSum $before 'everypicfound_cache_duration_seconds_count' @{ cache_name = 'text_vector'; operation = 'get'; result = 'hit' })
    $cacheTextGetMiss = Delta (Get-MetricSum $after 'everypicfound_cache_duration_seconds_count' @{ cache_name = 'text_vector'; operation = 'get'; result = 'miss' }) `
    ...
    $rows += [pscustomobject]@{
        ...
        model_vectorize_text_avg_ms = if ($modelCount -gt 0) { [math]::Round(($modelSum / $modelCount) * 1000, 2) } else { $null }
...
$rows | Sort-Object scenario, vu | Export-Csv -Path $csvPath -NoTypeInformation -Encoding utf8
